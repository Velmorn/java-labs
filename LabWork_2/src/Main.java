/*
    8. Знайти корінь кубічний з усіх елементів масиву з непарними індексами.

    Значення масиву заповнені псевдовипадковими числами з рівномірним розподілом у діапазоні від [0;1)

    Розмірність масиву задається як аргумент командного рядка.
*/
